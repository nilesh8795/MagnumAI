    ...
    <div className="container-fluid col-sm-12 home-content" style={{ marginTop: '100px' }}>
      <div className="col-sm-10" style={{ margin: 'auto' }}>
        <div className="row align-items-center" style={{ marginTop: '150px', margin: 'auto' }}>
          {/* Left Column */}
          <div className={`col-md-6 text-center text-md-start ${showElements.leftColumn ? 'animate__animated animate__fadeInUp' : ''}`} ref={leftColumnRef}>
          ...
          {/* Right Column */}
          <div className={`col-md-6 text-center text-md-end ${showElements.rightColumn ? 'animate__animated animate__fadeInUp' : ''}`} ref={rightColumnRef} style={{ marginTop: '50px' }}>
            <div className="row">
              <img
        ...
        <div className="row video-section" style={{ marginTop: '150px' , marginBottom: '50px'}}>
          <div className="col-12 d-flex justify-content-center">
            <video
              ...
              style={{ maxWidth: '100%', height: 'auto', borderRadius: '15px' }} // Added border-radius here
            >
